...
plot_position_adaptive = zeros(3, TIME_STEPS);
plot_desired_position_adaptive = zeros(3, TIME_STEPS);
plot_position_norm_adaptive = zeros(1, TIME_STEPS);
plot_position_norm_error_adaptive = zeros(1, TIME_STEPS);
plot_constraint_adaptive = zeros(1, TIME_STEPS);
plot_desired_position_norm_adaptive = zeros(1, TIME_STEPS);
plot_attitude_adaptive = zeros(4, TIME_STEPS);
plot_desired_attitude_adaptive = zeros(4, TIME_STEPS);
plot_attitude_error_adaptive = zeros(4, TIME_STEPS);
plot_angular_error_adaptive = zeros(1, TIME_STEPS);
plot_trans_gains_adaptive = zeros(3, TIME_STEPS);
plot_trans_kd_adaptive = zeros(3, TIME_STEPS);
plot_torques_adaptive = zeros(3, TIME_STEPS);
plot_thrust_adaptive = zeros(1, TIME_STEPS);
...
while t < SIM_TIME
    ...
    plot_position_adaptive(:, i) = position;
    plot_position_norm_adaptive(:, i) = r;
    plot_position_norm_error_adaptive(:, i) = r - rd;
    plot_constraint_adaptive(:,i) = restriction_radius;
    plot_desired_position_adaptive(:, i) = desired_position;
    plot_desired_position_norm_adaptive(:, i) = rd;
    [plot_attitude_adaptive(1,i),plot_attitude_adaptive(2,i),plot_attitude_adaptive(3,i),plot_attitude_adaptive(4,i)] = parts(orientation);
    [plot_desired_attitude_adaptive(1,i),plot_desired_attitude_adaptive(2,i),plot_desired_attitude_adaptive(3,i),plot_desired_attitude_adaptive(4,i)] = parts(desired_orientation);
    [plot_attitude_error_adaptive(1,i),plot_attitude_error_adaptive(2,i),plot_attitude_error_adaptive(3,i),plot_attitude_error_adaptive(4,i)] = parts(orientation_error);
    plot_angular_error_adaptive(i) = norm(rotvec(orientation_error));
    plot_trans_gains_adaptive(:,i) = trans_kp;
    plot_trans_kd_adaptive(:,i) = trans_kd;
    plot_torques_adaptive(:, i) = torque;
    if control_thrust < 0
        plot_thrust_adaptive(:, i) = 0;
    else
        plot_thrust_adaptive(:, i) = control_thrust;
    end
...
plot3(plot_position_adaptive(1, :), plot_position_adaptive(2, :), plot_position_adaptive(3, :),'LineWidth',2.5);
hold on
...
plot3(plot_desired_position_adaptive(1, :), plot_desired_position_adaptive(2, :), plot_desired_position_adaptive(3, :), 'r-.', 'LineWidth',2.5);
[sx,sy,sz] = sphere(60);
...
view([45,40])
grid off;
print('./plots/adaptive_control/3D_Trajectory', '-depsc2')

figure;
set(gcf,"Color",[1,1,1])
set(gcf,"Position",[80,220,1850,525])
set(gcf,"Renderer","painters")
plot(time, plot_attitude_adaptive(1, :), 'k','LineWidth',2.5);
hold on
plot(time, plot_attitude_adaptive(2, :), 'r','LineWidth',2.5);
plot(time, plot_attitude_adaptive(3, :), 'g','LineWidth',2.5);
plot(time, plot_attitude_adaptive(4, :), 'b','LineWidth',2.5);
plot(time, plot_desired_attitude_adaptive(1, :), 'k-.','LineWidth',2.5);
plot(time, plot_desired_attitude_adaptive(2, :), 'r-.','LineWidth',2.5);
plot(time, plot_desired_attitude_adaptive(3, :), 'g-.','LineWidth',2.5);
plot(time, plot_desired_attitude_adaptive(4, :), 'b-.','LineWidth',2.5);
xlim([0 SIM_TIME])
...
box("off")
grid off;
print('./plots/adaptive_control/Attitude', '-depsc2')
...
% set(gcf,"Position",[80,220,1850,525])
% set(gcf,"Renderer","painters")
% plot(time,plot_position_adaptive(1, :), 'r','LineWidth',2.5);
% hold on
% plot(time,plot_position_adaptive(2, :), 'g','LineWidth',2.5);
% plot(time,plot_position_adaptive(3, :), 'b','LineWidth',2.5);
% plot(time,plot_desired_position_adaptive(1, :), 'r-.','LineWidth',2.5);
% plot(time,plot_desired_position_adaptive(2, :), 'g-.','LineWidth',2.5);
% plot(time,plot_desired_position_adaptive(3, :), 'b-.','LineWidth',2.5);
% ylim([-2 2])
% xlim([0 SIM_TIME])
...
% grid off;
% box("off")
% print('./plots/adaptive_control/Position', '-depsc2')
...
plot(time,plot_desired_position_adaptive(1, :), 'r','LineWidth',2.5);
hold on
plot(time,plot_position_adaptive(1, :), 'r-.','LineWidth',0.5, 'Marker','o','MarkerEdgeColor', 'k' ,'MarkerFaceColor',[0.00,0.45,0.74],'MarkerIndices',marker_space);
...
grid off;
box("off")
print('./plots/adaptive_control/Position1', '-depsc2')
...
plot(time,plot_desired_position_adaptive(2, :), 'g','LineWidth',2.5);
hold on
plot(time,plot_position_adaptive(2, :), 'g-.','LineWidth',0.5, 'Marker','o','MarkerEdgeColor', 'k' ,'MarkerFaceColor',[1.00,0.41,0.16],'MarkerIndices',marker_space);
ylim([-1 1])
xlim([0 SIM_TIME])
legend('$p_y$','$p_{yr}$', ...
    'FontSize',24, 'interpreter', 'latex', ...
...
grid off;
box("off")
print('./plots/adaptive_control/Position2', '-depsc2')
...
plot(time,plot_desired_position_adaptive(3, :), 'b','LineWidth',2.5);
hold on
plot(time,plot_position_adaptive(3, :), 'b-.','LineWidth',.5, 'Marker','o','MarkerEdgeColor', 'k','MarkerFaceColor',[0.40,0.90,0.05],'MarkerIndices',marker_space);
ylim([-1 1])
xlim([0 SIM_TIME])
legend('$p_z$','$p_{zr}$', ...
    'FontSize',24, 'interpreter', 'latex', ...
...
grid off;
box("off")
print('./plots/adaptive_control/Position3', '-depsc2')
...
% set(gcf,"Position",[80,220,1850,525])
% set(gcf,"Renderer","painters")
% plot(time,plot_desired_position_norm_adaptive(1, :), 'r', 'LineWidth',2.5)
% hold on
% plot(time,plot_position_norm_adaptive(1, :), 'k-.','LineWidth',.5 ,'Marker','o','MarkerEdgeColor', 'k','MarkerFaceColor',[0,0.45,0.75],'MarkerIndices',marker_space);
...
% grid off;
% box("off")
% print('./plots/adaptive_control/Constraint', '-depsc2')
%
figure;
set(gcf,"Color",[1,1,1])
set(gcf,"Position",[80,220,1850,525])
set(gcf,"Renderer","painters")
plot(time,plot_trans_gains_adaptive(1, :), 'k','LineWidth',2.5);
hold on
plot(time,plot_trans_gains_adaptive(2, :), 'b','LineWidth',2.5);
plot(time,plot_trans_gains_adaptive(3, :), 'r','LineWidth',2.5);
% ylim([6 8])
xlim([0 SIM_TIME])
...
grid off;
box("off")
print('./plots/adaptive_control/tkp', '-depsc2')
%
% figure
% set(gcf,"Color",[1,1,1])
...
% grid off;
% box("off")
% print('./plots/adaptive_control/tkd', '-depsc2')

figure
set(gcf,"Color",[1,1,1])
set(gcf,"Position",[80,220,1850,525])
plot(time,plot_torques_adaptive(1, :), 'k','LineWidth',5);
hold on
plot(time,plot_torques_adaptive(2, :), 'b','LineWidth',5);
plot(time,plot_torques_adaptive(3, :), 'r','LineWidth',5);
ylim([-0.05 0.05])
xlim([0 SIM_TIME])
...
grid off;
box("off")
print('./plots/adaptive_control/torques', '-depsc2')

figure
set(gcf,"Color",[1,1,1])
set(gcf,"Position",[80,220,1850,525])
plot(time,plot_thrust_adaptive(1, :), 'k','LineWidth',2.5);
hold on
ylim([-1 1])
legend('$F_{th}$', ...
    'FontSize',24, 'interpreter', 'latex', ...
...
grid off;
box("off")
print('./plots/adaptive_control/thrust', '-depsc2')